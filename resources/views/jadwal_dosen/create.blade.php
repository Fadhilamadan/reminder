...
<section class="content-header">
    <h2 class="header-title">
        Create <small>Jadwal Dosen</small>
    </h2>
</section>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-color panel-primary">
                    <div class="panel-heading">Form New Jadwal Dosen</div>
                    <div class="panel-body">
                        <form method="POST" class="form-horizontal" role="form" action="{{ URL::to('/jadwal_dosen') }}">
