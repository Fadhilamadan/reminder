...
<section class="content-header">
    <h2 class="header-title">
        Create <small>Tugas Akhir</small>
    </h2>
</section>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-color panel-primary">
                    <div class="panel-heading">Form New Tugas Akhir</div>
                    <div class="panel-body">
                        <form method="POST" class="form-horizontal" role="form" action="{{ URL::to('/tugas_akhir') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="btn btn-default dropdown-toggle" data-toggle="dropdown" name="dosen_satu_id" style="width:100%;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="btn btn-default dropdown-toggle" data-toggle="dropdown" name="dosen_dua_id" style="width:100%;">
                                        @foreach ($dosen as $key => $value)
                                            <option value="{{ $value->id }}">
                                                {{ $value->npk . ' - ' . $value->name }}
                                            </option>
