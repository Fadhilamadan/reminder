...
<section class="content-header">
    <h2 class="header-title">
        Edit <small>Kerja Praktek</small>
    </h2>
</section>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-color panel-primary">
                    <div class="panel-heading">Form Edit Kerja Praktek</div>
                    <div class="panel-body">
                        <form method="POST" class="form-horizontal" role="form" action="{{ URL::to('/kerja_praktek', $kerja_praktek->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="title" value="{{ $kerja_praktek->title }}" placeholder="{{ $kerja_praktek->title }}" required="true">
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    <select class="btn btn-default dropdown-toggle" data-toggle="dropdown" name="mahasiswa_satu_id" style="width:100%;">
                                        @foreach ($mahasiswa as $key => $value)
                                            ...
                                            @if ($kerja_praktek->mahasiswa_satu_id == $value->id)
	                                                selected="selected">
	                                        @else
	                                        	>
	                                       	@endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="btn btn-default dropdown-toggle" data-toggle="dropdown" name="mahasiswa_dua_id" style="width:100%;">
                                        @foreach ($mahasiswa as $key => $value)
                                            <option value="{{ $value->id }}"
                                            @if ($kerja_praktek->mahasiswa_dua_id == $value->id)
	                                                selected="selected">
	                                        @else
	                                        	>
	                                       	@endif
                                ...
                                <div class="col-md-9">
                                    <select class="btn btn-default dropdown-toggle" data-toggle="dropdown" name="dosen_id" style="width:100%;">
                                        @foreach ($dosen as $key => $value)
                                            <option value="{{ $value->id }}"
                                            @if ($kerja_praktek->dosen_pembimbing_id == $value->id)
	                                                selected="selected">
	                                        @else
	                                        	>
	                                       	@endif
                                ...
                                <div class="col-md-9">
                                    <select class="btn btn-default dropdown-toggle" data-toggle="dropdown" name="periode_id" style="width:100%;">
                                        @foreach ($periode as $key => $value)
                                            <option value="{{ $value->id }}"
                                            @if ($kerja_praktek->periode_id == $value->id)
	                                                selected="selected">
	                                        @else
	                                        	>
	                                       	@endif
