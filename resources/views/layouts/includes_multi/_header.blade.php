        ...
        <div class="container">
            <div class="">
                ...
                <div class="topbar-left">
                    <div class="">
                        <a class="logo">
                            <img src="{{ asset('assets_multi/images/logo.png') }}" alt="logo" class="logo-lg" />
                            <img src="{{ asset('assets_multi/images/favicon.png') }}" alt="logo" class="logo-sm hidden" />
                        </a>
                    </div>
                </div>
                ...
                <ul class="nav navbar-nav navbar-right top-navbar-items-right pull-right">
                    ...
                    <li class="dropdown top-menu-item-xs">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php $url = "../setting_dosen/" . Auth::user()->owner_id . "/edit"; ?>
                            <li><a href="<?php echo $url; ?>"><i class="ti-settings m-r-10"></i> Settings</a></li>
