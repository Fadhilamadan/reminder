...
!function($) {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        ...
        var mEnd = moment(end, 'YYYY-MM-DDTHH:mm:ssZ').format();
        var dStart = mStart.substring(0, 10);
        mStart = mStart.substring(11, 19);
        mEnd = mEnd.substring(11, 19);
            ...
            form.find(".row")
                .append("<div class='col-md-12'><div class='form-group'><label class='control-label'>Detail Slot</label><select class='form-control' name='detail' id='detail'></select></div></div>")
                .append("<div class='col-md-12'><div class='form-group'><label class='control-label'>Place</label><input class='form-control' placeholder='Place' type='text' name='place'/></div></div><input type='hidden' name='status' value='Waiting'/>")
                .append("<input type='hidden' name='date' value='" + dStart + "'/><input type='hidden' name='start' value='" + mStart + "'/><input type='hidden' name='end' value='" + mEnd + "'/><input type='hidden' name='isRequest' value='0'/>");
            ...
            $this.$modal.find('form').on('submit', function () {
                ...
                if ((title !== null && title.length != 0) && (place !== null && place.length != 0)) {
                    ...
                    alert('You have to give a title/place to your slot');
                }
                return false;
            });
